...
<head>
    ...
    <!-- Custom Fonts -->
    <link href="App/bootstrap/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">

    <!-- DataTables CSS -->
    <link href="App/Plugins/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.css" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="App/Plugins/datatables-responsive/css/responsive.dataTables.css" rel="stylesheet">

    <!-- Tree -->
    <link rel="stylesheet" href="app/Css/filetree.css" type="text/css" >
...
<body>
                                                                                    ...
                                                                                    if (!is_dir($link)) {
                                                                                        ...
                                                                                        switch ($partes_ruta['extension']) {
                                                                                                        ...
                                                                                                        case "jpeg":
                                                                                                            ...
                                                                                                            {$thumbs = "App/Img/iconos/JPEG.png"; break;}

                                                                                                        case "png";
                                                                                                        case "PNG":

                                                                                                            {$thumbs = "App/Img/iconos/PNG.png"; break;}

                                                                                                        case "gif":

                                                                                                            {$thumbs = "App/Img/iconos/GIF.png"; break;}

                                                                                                        case "jpeg";
                                                                                                        case "bmp":

                                                                                                            {$thumbs = "App/Img/iconos/IMG.png"; break;}

                                                                                                        case "doc";
                                                                                                        case "docx":

                                                                                                            {$thumbs = "App/Img/iconos/DOC.png"; break;}

                                                                                                        case "pdf":

                                                                                                            {$thumbs = "App/Img/iconos/PDF.png"; break;}

                                                                                                        case "xls";
                                                                                                        case "xlsx":

                                                                                                            {$thumbs = "App/Img/iconos/XLS.png"; break;}

                                                                                                        case "mp3":

                                                                                                            {$thumbs = "App/Img/iconos/MP3.png"; break;}

                                                                                                        case "mp4":

                                                                                                            {$thumbs = "App/Img/iconos/MP4.png"; break;}

                                                                                                        default:
                                                                                                            {$thumbs = "App/Img/iconos/UNKNOWN.png"; break;}
                                                                                                            break;
                                                                                                    }
                                                                                        ...
                                                                                        ';
                                                                                            ...
                                                                                            $thumbs = "App/Img/iconos/Folder Blank.png";
    ...
    <!-- /#wrapper -->
    <!-- Js .-->
    <script src="App/Js/jquery-2.2.1.js"></script>
	<script src="App/bootstrap/js/bootstrap.min.js"></script>

    <!-- DataTables JavaScript -->
    <script src="App/Plugins/datatables/media/js/jquery.dataTables.js"></script>
    <script src="App/Plugins/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.min.js"></script>

    <!-- JavaScript Includes -->
    <script src="App/Plugins/upload/assets/js/jquery.knob.js"></script>

    <!-- jQuery File Upload Dependencies -->
    <script src="App/Plugins/upload/assets/js/jquery.ui.widget.js"></script>
    <script src="App/Plugins/upload/assets/js/jquery.iframe-transport.js"></script>
    <script src="App/Plugins/upload/assets/js/jquery.fileupload.js"></script>
